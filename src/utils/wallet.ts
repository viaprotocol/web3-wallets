import { BTC_WALLETS_CONFIG, COSMOS_WALLETS_CONFIG, EVM_WALLETS_CONFIG, SOL_WALLETS_CONFIG, isBTCChain, isCosmosChain, isEvmChain, isSolChain } from '..'
...
const isBTClikeWallet = (walletData: TWalletStore, fromChainId?: number): walletData is TBTCWalletStore => {
  return BTC_WALLETS_CONFIG.includes(walletData.name as any) && (!fromChainId || isBTCChain(fromChainId))
}
